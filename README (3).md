...
elemento aparezca una sola vez? para evitar duplicaciones, elementos unicos
...
Si add() devuelve false, indica que el elemento ya existe en el Set yes un registro duplicado.
